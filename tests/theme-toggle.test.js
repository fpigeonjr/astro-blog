...
describe('Theme Toggle Functionality', () => {
  ...
  it('should create desktop theme toggle with correct structure', () => {
    ...
    const toggle = getByRole(container, 'button', { name: /toggle dark mode/i });
  ...
  it('should update both desktop and mobile toggles simultaneously', async () => {
    ...
    expect(desktopToggle.getAttribute('aria-label')).toBe('Switch to dark mode');
    ...
    expect(desktopToggle.getAttribute('aria-label')).toBe('Switch to light mode');
    expect(mobileToggle.getAttribute('aria-label')).toBe('Switch to light mode');
